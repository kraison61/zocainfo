...
export default function Footer() {
  ...
  const company = [
    { name: 'About Zoca', href: 'about-us' },
    { name: 'How It Works', href: '#how' },
    { name: 'Customer Reviews', href: '#testimonials' },
    { name: 'Loan Rates & Fees', href: '#calculator' },
  ]
    ...
    <footer className="text-white bg-gray-900">
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div id="disclaimer" className='text-gray-400'>
              <h3 className='text-white'>Disclaimer Section</h3>
...
<br />
<h3 className='text-white'>Affiliate Disclosure</h3>
<p>Zoca Loans may receive compensation from third-party partners when users click on links or submit requests. This does not impact the cost or terms offered to users.</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 text-sm text-gray-400 border-t border-gray-800 md:flex-row">
          ...
          <p>
            Customer Service: +1 (855) 826-4788 | Email: support@zocaloans.info
          </p>
        </div>
      </div>
    </footer>
